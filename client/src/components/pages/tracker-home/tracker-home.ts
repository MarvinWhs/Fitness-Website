      ...
      <div class="tracker-home">
        ...
        <div class="Erklärung">
          ...
          <ul>
            ...
            <li>
              <strong>Übersicht behalten: </strong> Sehen Sie auf einen Blick, wie viele Kalorien Sie bereits konsumiert
              haben und wie viele Ihnen noch zur Verfügung stehen. Unser übersichtliches Dashboard zeigt Ihnen Ihre
              Fortschritte und hilft Ihnen, bewusste Ernährungsentscheidungen zu treffen.
            </li>
          </ul>
        </div>
